...
const _b = '';

export const metadata: Metadata = {
  title: 'Create Biz Reward – CL2U',
  description: 'Create Biz Reward — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/biz-rewards/create-biz-reward/' },
  openGraph: {
    title: 'Create Biz Reward',
    description: 'Create Biz Reward — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/biz-rewards/create-biz-reward/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create Biz Reward">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Create Biz Reward</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create Biz Reward</h1>
