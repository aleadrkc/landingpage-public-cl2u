...
const _b = '';

export const metadata: Metadata = {
  title: 'Delete Biz Reward – CL2U',
  description: 'Delete Biz Reward — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/biz-rewards/delete-biz-reward/' },
  openGraph: {
    title: 'Delete Biz Reward',
    description: 'Delete Biz Reward — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/biz-rewards/delete-biz-reward/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Delete Biz Reward">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Delete Biz Reward</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Delete Biz Reward</h1>
