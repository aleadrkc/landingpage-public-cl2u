...
const _b = '';

export const metadata: Metadata = {
  title: 'Add Shops to Saved Business List – CL2U',
  description: 'Add Shops to Saved Business List — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/saved-business/add-shops-to-saved-business-list/' },
  openGraph: {
    title: 'Add Shops to Saved Business List',
    description: 'Add Shops to Saved Business List — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/saved-business/add-shops-to-saved-business-list/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Add Shops to Saved Business List">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Add Shops to Saved Business List</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Add Shops to Saved Business List</h1>
