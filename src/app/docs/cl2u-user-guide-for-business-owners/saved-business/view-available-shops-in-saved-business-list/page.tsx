...
const _b = '';

export const metadata: Metadata = {
  title: 'View Available Shops and Shops Details in Saved Business List – CL2U',
  description: 'View Available Shops and Shops Details in Saved Business List — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/saved-business/view-available-shops-in-saved-business-list/' },
  openGraph: {
    title: 'View Available Shops and Shops Details in Saved Business List',
    description: 'View Available Shops and Shops Details in Saved Business List — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/saved-business/view-available-shops-in-saved-business-list/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Available Shops and Shops Details in Saved Business List">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Available Shops and Shops Details in Saved Business List</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Available Shops and Shops Details in Saved Business List</h1>
