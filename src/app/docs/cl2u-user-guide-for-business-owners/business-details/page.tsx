...
const _b = '';

export const metadata: Metadata = {
  title: 'Business Details – CL2U',
  description: 'Business Details section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/business-details/' },
  openGraph: {
    title: 'Business Details',
    description: 'Business Details section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/business-details/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Business Details">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Business Details</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Business Details</h1>
