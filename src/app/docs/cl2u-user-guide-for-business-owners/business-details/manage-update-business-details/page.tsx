...
const _b = 'PHA+Q3VycmVudGx5LCBhZnRlciBhIEJ1c2luZXNzIGFjY291bnQgaXMgdmVyaWZpZWQsIHRoZSBidXNpbmVzcyBvd25lciBuZWVkcyB0byBtYW51YWxseSBjb250YWN0IENMMlUgdG8gdXBkYXRlIHRoZSBidXNpbmVzcyBpbmZvLjwvcD4=';

export const metadata: Metadata = {
  title: 'Manage/Update Business Details – CL2U',
  description: 'Manage/Update Business Details — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/business-details/manage-update-business-details/' },
  openGraph: {
    title: 'Manage/Update Business Details',
    description: 'Manage/Update Business Details — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/business-details/manage-update-business-details/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage/Update Business Details">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manage/Update Business Details</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage/Update Business Details</h1>
              ...
              <footer className="wedocs-entry-footer-clone">
                ...
                <time dateTime="2023-03-10T16:36:58+08:00">Updated on May 5, 2020</time>
              </footer>
            </article>
          </div>
        </section>
