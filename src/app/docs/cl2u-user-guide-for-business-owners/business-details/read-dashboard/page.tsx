...
const _b = '';

export const metadata: Metadata = {
  title: 'Read Dashboard – CL2U',
  description: 'Read Dashboard — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/business-details/read-dashboard/' },
  openGraph: {
    title: 'Read Dashboard',
    description: 'Read Dashboard — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/business-details/read-dashboard/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Read Dashboard">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide-for-business-owners/business-details/">Business Details</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Read Dashboard</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Read Dashboard</h1>
