...
const _b = '';

export const metadata: Metadata = {
  title: 'Manually Enroll a Player to a Tournament – CL2U',
  description: 'Manually Enroll a Player to a Tournament — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/tournaments/manually-enroll-a-player-to-a-tournament/' },
  openGraph: {
    title: 'Manually Enroll a Player to a Tournament',
    description: 'Manually Enroll a Player to a Tournament — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/tournaments/manually-enroll-a-player-to-a-tournament/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manually Enroll a Player to a Tournament">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manually Enroll a Player to a Tournament</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manually Enroll a Player to a Tournament</h1>
