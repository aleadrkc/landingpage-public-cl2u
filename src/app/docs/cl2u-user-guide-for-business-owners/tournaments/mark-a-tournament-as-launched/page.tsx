...
const _b = '';

export const metadata: Metadata = {
  title: 'Mark a Tournament As Launched – CL2U',
  description: 'Mark a Tournament As Launched — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/tournaments/mark-a-tournament-as-launched/' },
  openGraph: {
    title: 'Mark a Tournament As Launched',
    description: 'Mark a Tournament As Launched — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/tournaments/mark-a-tournament-as-launched/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Mark a Tournament As Launched">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Mark a Tournament As Launched</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Mark a Tournament As Launched</h1>
