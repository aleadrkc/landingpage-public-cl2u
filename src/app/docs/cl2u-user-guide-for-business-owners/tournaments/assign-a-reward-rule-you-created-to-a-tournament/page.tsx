...
const _b = '';

export const metadata: Metadata = {
  title: 'Assign a Reward Rule You Created to a Tournament – CL2U',
  description: 'Assign a Reward Rule You Created to a Tournament — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/tournaments/assign-a-reward-rule-you-created-to-a-tournament/' },
  openGraph: {
    title: 'Assign a Reward Rule You Created to a Tournament',
    description: 'Assign a Reward Rule You Created to a Tournament — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/tournaments/assign-a-reward-rule-you-created-to-a-tournament/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Assign a Reward Rule You Created to a Tournament">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Assign a Reward Rule You Created to a Tournament</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Assign a Reward Rule You Created to a Tournament</h1>
