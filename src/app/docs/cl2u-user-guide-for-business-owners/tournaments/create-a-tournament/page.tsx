...
const _b = '';

export const metadata: Metadata = {
  title: 'Create a Tournament and Team Tournament – CL2U',
  description: 'Create a Tournament and Team Tournament — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/tournaments/create-a-tournament/' },
  openGraph: {
    title: 'Create a Tournament and Team Tournament',
    description: 'Create a Tournament and Team Tournament — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/tournaments/create-a-tournament/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create a Tournament and Team Tournament">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Create a Tournament and Team Tournament</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create a Tournament and Team Tournament</h1>
