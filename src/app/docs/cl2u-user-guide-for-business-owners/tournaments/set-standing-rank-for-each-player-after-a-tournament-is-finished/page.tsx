...
const _b = '';

export const metadata: Metadata = {
  title: 'Set Standing/Rank for Each Player after a Tournament is Finished – CL2U',
  description: 'Set Standing/Rank for Each Player after a Tournament is Finished — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/tournaments/set-standing-rank-for-each-player-after-a-tournament-is-finished/' },
  openGraph: {
    title: 'Set Standing/Rank for Each Player after a Tournament is Finished',
    description: 'Set Standing/Rank for Each Player after a Tournament is Finished — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/tournaments/set-standing-rank-for-each-player-after-a-tournament-is-finished/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Set Standing/Rank for Each Player after a Tournament is Finished">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Set Standing/Rank for Each Player after a Tournament is Finished</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Set Standing/Rank for Each Player after a Tournament is Finished</h1>
