...
const _b = '';

export const metadata: Metadata = {
  title: 'Edit an Event’s Data – CL2U',
  description: 'Edit an Event’s Data — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/events/edit-an-events-data/' },
  openGraph: {
    title: 'Edit an Event’s Data',
    description: 'Edit an Event’s Data — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/events/edit-an-events-data/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Edit an Event’s Data">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Edit an Event’s Data</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Edit an Event’s Data</h1>
