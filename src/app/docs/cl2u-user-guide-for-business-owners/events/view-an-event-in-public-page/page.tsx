...
const _b = '';

export const metadata: Metadata = {
  title: 'View an Event in Public Page – CL2U',
  description: 'View an Event in Public Page — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/events/view-an-event-in-public-page/' },
  openGraph: {
    title: 'View an Event in Public Page',
    description: 'View an Event in Public Page — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/events/view-an-event-in-public-page/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View an Event in Public Page">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View an Event in Public Page</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View an Event in Public Page</h1>
