...
const _b = '';

export const metadata: Metadata = {
  title: 'Events – CL2U',
  description: 'Events section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/events/' },
  openGraph: {
    title: 'Events',
    description: 'Events section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/events/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Events">
