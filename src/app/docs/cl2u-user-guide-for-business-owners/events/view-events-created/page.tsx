...
const _b = '';

export const metadata: Metadata = {
  title: 'View List of Created Events – CL2U',
  description: 'View List of Created Events — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/events/view-events-created/' },
  openGraph: {
    title: 'View List of Created Events',
    description: 'View List of Created Events — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/events/view-events-created/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View List of Created Events">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View List of Created Events</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View List of Created Events</h1>
