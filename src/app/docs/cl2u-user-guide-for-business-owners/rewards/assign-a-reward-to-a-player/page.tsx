...
const _b = '';

export const metadata: Metadata = {
  title: 'Assign a Reward to a Player – CL2U',
  description: 'Assign a Reward to a Player — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/rewards/assign-a-reward-to-a-player/' },
  openGraph: {
    title: 'Assign a Reward to a Player',
    description: 'Assign a Reward to a Player — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/rewards/assign-a-reward-to-a-player/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Assign a Reward to a Player">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Assign a Reward to a Player</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Assign a Reward to a Player</h1>
