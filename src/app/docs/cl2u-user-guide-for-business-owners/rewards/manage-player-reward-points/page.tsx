...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Player Reward Points – CL2U',
  description: 'Manage Player Reward Points — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-player-reward-points/' },
  openGraph: {
    title: 'Manage Player Reward Points',
    description: 'Manage Player Reward Points — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-player-reward-points/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Player Reward Points">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manage Player Reward Points</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Player Reward Points</h1>
