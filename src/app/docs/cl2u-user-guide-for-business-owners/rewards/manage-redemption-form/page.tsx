...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Redemption Form – CL2U',
  description: 'Manage Redemption Form — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-redemption-form/' },
  openGraph: {
    title: 'Manage Redemption Form',
    description: 'Manage Redemption Form — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-redemption-form/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Redemption Form">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manage Redemption Form</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Redemption Form</h1>
