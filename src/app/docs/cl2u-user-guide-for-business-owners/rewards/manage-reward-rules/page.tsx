...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Reward Rules – CL2U',
  description: 'Manage Reward Rules — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-reward-rules/' },
  openGraph: {
    title: 'Manage Reward Rules',
    description: 'Manage Reward Rules — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/rewards/manage-reward-rules/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Reward Rules">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide-for-business-owners/rewards/">Rewards</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Manage Reward Rules</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Reward Rules</h1>
