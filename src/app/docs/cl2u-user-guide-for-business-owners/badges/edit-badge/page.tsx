...
const _b = '';

export const metadata: Metadata = {
  title: 'Edit Badge – CL2U',
  description: 'Edit Badge — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/badges/edit-badge/' },
  openGraph: {
    title: 'Edit Badge',
    description: 'Edit Badge — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/badges/edit-badge/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Edit Badge">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Edit Badge</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Edit Badge</h1>
