...
const _b = '';

export const metadata: Metadata = {
  title: 'Create Badge – CL2U',
  description: 'Create Badge — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/badges/create-badge/' },
  openGraph: {
    title: 'Create Badge',
    description: 'Create Badge — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/badges/create-badge/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create Badge">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Create Badge</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create Badge</h1>
