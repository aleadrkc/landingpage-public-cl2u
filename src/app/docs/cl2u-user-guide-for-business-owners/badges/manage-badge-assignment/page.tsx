...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Badge Assignment – CL2U',
  description: 'Manage Badge Assignment — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/badges/manage-badge-assignment/' },
  openGraph: {
    title: 'Manage Badge Assignment',
    description: 'Manage Badge Assignment — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/badges/manage-badge-assignment/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Badge Assignment">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide-for-business-owners/badges/">Badges</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Manage Badge Assignment</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Badge Assignment</h1>
