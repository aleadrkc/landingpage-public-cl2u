...
const _b = '';

export const metadata: Metadata = {
  title: 'Badges – CL2U',
  description: 'Badges section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/badges/' },
  openGraph: {
    title: 'Badges',
    description: 'Badges section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/badges/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Badges">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              ...
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Badges</h1>
