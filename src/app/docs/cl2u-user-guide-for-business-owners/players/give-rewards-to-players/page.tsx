...
const _b = '';

export const metadata: Metadata = {
  title: 'Give Rewards to Players – CL2U',
  description: 'Give Rewards to Players — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/players/give-rewards-to-players/' },
  openGraph: {
    title: 'Give Rewards to Players',
    description: 'Give Rewards to Players — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/players/give-rewards-to-players/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Give Rewards to Players">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide-for-business-owners/players/">Players</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Give Rewards to Players</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Give Rewards to Players</h1>
