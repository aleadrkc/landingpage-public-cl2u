...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Players – CL2U',
  description: 'Manage Players — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/players/manage-players/' },
  openGraph: {
    title: 'Manage Players',
    description: 'Manage Players — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/players/manage-players/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Players">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              ...
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Players</h1>
