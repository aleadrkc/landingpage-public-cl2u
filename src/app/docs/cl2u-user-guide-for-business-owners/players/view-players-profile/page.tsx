...
const _b = '';

export const metadata: Metadata = {
  title: 'View Player’s Profile – CL2U',
  description: 'View Player’s Profile — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/players/view-players-profile/' },
  openGraph: {
    title: 'View Player’s Profile',
    description: 'View Player’s Profile — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/players/view-players-profile/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Player’s Profile">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Player’s Profile</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Player’s Profile</h1>
