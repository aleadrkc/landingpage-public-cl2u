...
const _b = '';

export const metadata: Metadata = {
  title: 'Create New Shop – CL2U',
  description: 'Create New Shop — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/shops/create-new-shop/' },
  openGraph: {
    title: 'Create New Shop',
    description: 'Create New Shop — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/shops/create-new-shop/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create New Shop">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide-for-business-owners/shops/">Shops</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Create New Shop</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create New Shop</h1>
