...
const _b = '';

export const metadata: Metadata = {
  title: 'Edit Shop Details – CL2U',
  description: 'Edit Shop Details — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/shops/edit-shop-details/' },
  openGraph: {
    title: 'Edit Shop Details',
    description: 'Edit Shop Details — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/shops/edit-shop-details/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Edit Shop Details">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Edit Shop Details</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Edit Shop Details</h1>
