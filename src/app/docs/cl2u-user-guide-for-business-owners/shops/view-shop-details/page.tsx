...
const _b = '';

export const metadata: Metadata = {
  title: 'View Shop Details – CL2U',
  description: 'View Shop Details — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/shops/view-shop-details/' },
  openGraph: {
    title: 'View Shop Details',
    description: 'View Shop Details — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/shops/view-shop-details/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Shop Details">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Shop Details</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Shop Details</h1>
