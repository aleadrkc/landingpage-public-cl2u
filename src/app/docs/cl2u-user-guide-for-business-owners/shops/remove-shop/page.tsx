...
const _b = '';

export const metadata: Metadata = {
  title: 'Remove Shop – CL2U',
  description: 'Remove Shop — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/shops/remove-shop/' },
  openGraph: {
    title: 'Remove Shop',
    description: 'Remove Shop — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/shops/remove-shop/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Remove Shop">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Remove Shop</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Remove Shop</h1>
