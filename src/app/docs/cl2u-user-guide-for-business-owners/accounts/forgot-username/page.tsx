...
const _b = '';

export const metadata: Metadata = {
  title: 'Forgot Username – CL2U',
  description: 'Forgot Username — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/accounts/forgot-username/' },
  openGraph: {
    title: 'Forgot Username',
    description: 'Forgot Username — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/accounts/forgot-username/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Forgot Username">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Forgot Username</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Forgot Username</h1>
