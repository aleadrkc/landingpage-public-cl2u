...
const _b = '';

export const metadata: Metadata = {
  title: 'Create a Business Account – CL2U',
  description: 'Create a Business Account — documentation section in the CL2U User Guide for Business Owners.',
  alternates: { canonical: '/docs/cl2u-user-guide-for-business-owners/accounts/create-a-business-account/' },
  openGraph: {
    title: 'Create a Business Account',
    description: 'Create a Business Account — documentation section in the CL2U User Guide for Business Owners.',
    url: '/docs/cl2u-user-guide-for-business-owners/accounts/create-a-business-account/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create a Business Account">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Create a Business Account</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create a Business Account</h1>
              ...
              <footer className="wedocs-entry-footer-clone">
                ...
                <time dateTime="2023-03-10T16:36:58+08:00">Updated on February 21, 2023</time>
              </footer>
            </article>
          </div>
        </section>
