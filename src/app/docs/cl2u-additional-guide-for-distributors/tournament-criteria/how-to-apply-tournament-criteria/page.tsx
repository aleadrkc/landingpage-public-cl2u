...
const _b = '';

export const metadata: Metadata = {
  title: 'How to Apply Tournament Criteria – CL2U',
  description: 'How to Apply Tournament Criteria — documentation section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/tournament-criteria/how-to-apply-tournament-criteria/' },
  openGraph: {
    title: 'How to Apply Tournament Criteria',
    description: 'How to Apply Tournament Criteria — documentation section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/tournament-criteria/how-to-apply-tournament-criteria/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="How to Apply Tournament Criteria">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-additional-guide-for-distributors/tournament-criteria/">Tournament Criteria</a></li>
                <li aria-hidden="true">›</li>
                <li><span>How to Apply Tournament Criteria</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">How to Apply Tournament Criteria</h1>
