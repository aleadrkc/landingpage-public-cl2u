...
const _b = '';

export const metadata: Metadata = {
  title: 'Tournament Criteria – CL2U',
  description: 'Tournament Criteria section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/tournament-criteria/' },
  openGraph: {
    title: 'Tournament Criteria',
    description: 'Tournament Criteria section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/tournament-criteria/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Tournament Criteria">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Tournament Criteria</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Tournament Criteria</h1>
