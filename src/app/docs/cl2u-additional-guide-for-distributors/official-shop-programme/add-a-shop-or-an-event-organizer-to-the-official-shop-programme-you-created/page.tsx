...
const _b = '';

export const metadata: Metadata = {
  title: 'Add a Shop or an Event Organizer to the Official Shop Programme You Created – CL2U',
  description: 'Add a Shop or an Event Organizer to the Official Shop Programme You Created — documentation section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/official-shop-programme/add-a-shop-or-an-event-organizer-to-the-official-shop-programme-you-created/' },
  openGraph: {
    title: 'Add a Shop or an Event Organizer to the Official Shop Programme You Created',
    description: 'Add a Shop or an Event Organizer to the Official Shop Programme You Created — documentation section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/official-shop-programme/add-a-shop-or-an-event-organizer-to-the-official-shop-programme-you-created/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Add a Shop or an Event Organizer to the Official Shop Programme You Created">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Add a Shop or an Event Organizer to the Official Shop Programme You Created</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Add a Shop or an Event Organizer to the Official Shop Programme You Created</h1>
