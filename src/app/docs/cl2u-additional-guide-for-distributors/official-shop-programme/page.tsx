...
const _b = '';

export const metadata: Metadata = {
  title: 'Official Shop Programme – CL2U',
  description: 'Official Shop Programme section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/official-shop-programme/' },
  openGraph: {
    title: 'Official Shop Programme',
    description: 'Official Shop Programme section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/official-shop-programme/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Official Shop Programme">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Official Shop Programme</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Official Shop Programme</h1>
