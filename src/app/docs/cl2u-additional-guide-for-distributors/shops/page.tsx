...
const _b = '';

export const metadata: Metadata = {
  title: 'Shops – CL2U',
  description: 'Shops section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/shops/' },
  openGraph: {
    title: 'Shops',
    description: 'Shops section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/shops/',
    siteName: 'CL2U',
