...
const _b = '';

export const metadata: Metadata = {
  title: 'Manage Shops Selling Your Products – CL2U',
  description: 'Manage Shops Selling Your Products — documentation section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/shops/manage-shops-distributing-your-products/' },
  openGraph: {
    title: 'Manage Shops Selling Your Products',
    description: 'Manage Shops Selling Your Products — documentation section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/shops/manage-shops-distributing-your-products/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Shops Selling Your Products">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manage Shops Selling Your Products</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Shops Selling Your Products</h1>
