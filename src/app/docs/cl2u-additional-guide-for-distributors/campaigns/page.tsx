...
const _b = 'PGgzPkFydGljbGVzPC9oMz48dWw+PGxpID48YSBocmVmPSIvZG9jcy9jbDJ1LWFkZGl0aW9uYWwtZ3VpZGUtZm9yLWRpc3RyaWJ1dG9ycy9jYW1wYWlnbnMvbWFuYWdlLWNhbXBhaWducy8iPk1hbmFnZSBDYW1wYWlnbnM8L2E+PC9saT4KPC91bD4=';

export const metadata: Metadata = {
  title: 'Campaigns – CL2U',
  description: 'Campaigns section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/campaigns/' },
  openGraph: {
    title: 'Campaigns',
    description: 'Campaigns section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/campaigns/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Campaigns">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              ...
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Campaigns</h1>
