...
const _b = '';

export const metadata: Metadata = {
  title: 'Create A New List for Your Favorite Business – CL2U',
  description: 'Create A New List for Your Favorite Business — documentation section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/saved-business/create-a-new-list-for-your-favorite-business/' },
  openGraph: {
    title: 'Create A New List for Your Favorite Business',
    description: 'Create A New List for Your Favorite Business — documentation section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/saved-business/create-a-new-list-for-your-favorite-business/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Create A New List for Your Favorite Business">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Create A New List for Your Favorite Business</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Create A New List for Your Favorite Business</h1>
