...
const _b = '';

export const metadata: Metadata = {
  title: 'Add a Business into Your Saved Business List – CL2U',
  description: 'Add a Business into Your Saved Business List — documentation section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/saved-business/add-a-business-into-your-saved-business-list/' },
  openGraph: {
    title: 'Add a Business into Your Saved Business List',
    description: 'Add a Business into Your Saved Business List — documentation section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/saved-business/add-a-business-into-your-saved-business-list/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Add a Business into Your Saved Business List">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Add a Business into Your Saved Business List</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Add a Business into Your Saved Business List</h1>
