...
const _b = '';

export const metadata: Metadata = {
  title: 'Adventure Campaigns – CL2U',
  description: 'Adventure Campaigns section in the CL2U Additional Guide for Distributors.',
  alternates: { canonical: '/docs/cl2u-additional-guide-for-distributors/adventure-campaigns/' },
  openGraph: {
    title: 'Adventure Campaigns',
    description: 'Adventure Campaigns section in the CL2U Additional Guide for Distributors.',
    url: '/docs/cl2u-additional-guide-for-distributors/adventure-campaigns/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Adventure Campaigns">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Adventure Campaigns</span></li>
              </ol>

              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Adventure Campaigns</h1>
