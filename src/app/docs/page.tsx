...
const guideGroups = [
  {
    ...
    sections: [
      ...
      ['Decks', `${origin}/docs/cl2u-user-guide/decks/`],
      ['Shops', `${origin}/docs/cl2u-user-guide/shops/`],
      ['Rewards', `${origin}/docs/cl2u-user-guide/rewards/`],
      ['Adventures', `${origin}/docs/cl2u-user-guide/adventures/`],
      ['Biz Rewards', `${origin}/docs/cl2u-user-guide/biz-rewards/`],
    ],
  },
  {
    ...
    sections: [
      ...
      ['Events', `${origin}/docs/cl2u-user-guide-for-business-owners/events/`],
      ['Tournaments', `${origin}/docs/cl2u-user-guide-for-business-owners/tournaments/`],
      ['Official Shop Programme', `${origin}/docs/cl2u-user-guide-for-business-owners/official-shop-programme/`],
      ['Players', `${origin}/docs/cl2u-user-guide-for-business-owners/players/`],
      ['Saved Business', `${origin}/docs/cl2u-user-guide-for-business-owners/saved-business/`],
  ...
  },
  {
    ...
    sections: [
      ...
      ['Shops', `${origin}/docs/cl2u-additional-guide-for-distributors/shops/`],
      ['Staff', `${origin}/docs/cl2u-additional-guide-for-distributors/staff/`],
      ['Adventure Campaigns', `${origin}/docs/cl2u-additional-guide-for-distributors/adventure-campaigns/`],
      ['Campaigns', `${origin}/docs/cl2u-additional-guide-for-distributors/campaigns/`],
      ['Tournament Criteria', `${origin}/docs/cl2u-additional-guide-for-distributors/tournament-criteria/`],
    ],
  },
  {
