...
const _b = '';
export const metadata: Metadata = {
  title: 'View Tournaments (Held by Shop) – CL2U',
  description: 'View Tournaments (Held by Shop) — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/shops/view-tournaments-held-by-shop/' },
  openGraph: {
    title: 'View Tournaments (Held by Shop)',
    description: 'View Tournaments (Held by Shop) — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/shops/view-tournaments-held-by-shop/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Tournaments (Held by Shop)">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Tournaments (Held by Shop)</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Tournaments (Held by Shop)</h1>
