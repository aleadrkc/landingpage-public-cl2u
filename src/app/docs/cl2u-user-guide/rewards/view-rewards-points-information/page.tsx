...
const _b = '';
export const metadata: Metadata = {
  title: 'View Rewards Points Information – CL2U',
  description: 'View Rewards Points Information — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/rewards/view-rewards-points-information/' },
  openGraph: {
    title: 'View Rewards Points Information',
    description: 'View Rewards Points Information — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/rewards/view-rewards-points-information/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Rewards Points Information">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide/rewards/">Rewards</a></li>
                <li aria-hidden="true">›</li>
                <li><span>View Rewards Points Information</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Rewards Points Information</h1>
