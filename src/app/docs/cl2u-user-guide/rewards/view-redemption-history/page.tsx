...
const _b = '';
export const metadata: Metadata = {
  title: 'View Redemption History – CL2U',
  description: 'View Redemption History — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/rewards/view-redemption-history/' },
  openGraph: {
    title: 'View Redemption History',
    description: 'View Redemption History — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/rewards/view-redemption-history/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Redemption History">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Redemption History</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Redemption History</h1>
