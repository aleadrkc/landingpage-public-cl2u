...
const _b = '';
export const metadata: Metadata = {
  title: 'Redeem Rewards – CL2U',
  description: 'Redeem Rewards — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/rewards/redeem-rewards/' },
  openGraph: {
    title: 'Redeem Rewards',
    description: 'Redeem Rewards — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/rewards/redeem-rewards/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Redeem Rewards">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Redeem Rewards</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Redeem Rewards</h1>
