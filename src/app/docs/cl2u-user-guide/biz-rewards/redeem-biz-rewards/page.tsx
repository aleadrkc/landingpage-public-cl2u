...
const _b = '';
export const metadata: Metadata = {
  title: 'Redeem Biz Rewards – CL2U',
  description: 'Redeem Biz Rewards — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/biz-rewards/redeem-biz-rewards/' },
  openGraph: {
    title: 'Redeem Biz Rewards',
    description: 'Redeem Biz Rewards — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/biz-rewards/redeem-biz-rewards/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Redeem Biz Rewards">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><a href="/docs/cl2u-user-guide/biz-rewards/">Biz Rewards</a></li>
                <li aria-hidden="true">›</li>
                <li><span>Redeem Biz Rewards</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Redeem Biz Rewards</h1>
