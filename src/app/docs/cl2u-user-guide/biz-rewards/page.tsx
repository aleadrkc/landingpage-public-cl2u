...
const _b = 'PGgzPkFydGljbGVzPC9oMz48dWw+PGxpID48YSBocmVmPSIvZG9jcy9jbDJ1LXVzZXItZ3VpZGUvYml6LXJld2FyZHMvcmVkZWVtLWJpei1yZXdhcmRzLyI+UmVkZWVtIEJpeiBSZXdhcmRzPC9hPjwvbGk+CjwvdWw+';
export const metadata: Metadata = {
  title: 'Biz Rewards – CL2U',
  description: 'Biz Rewards section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/biz-rewards/' },
  openGraph: {
    title: 'Biz Rewards',
    description: 'Biz Rewards section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/biz-rewards/',
    siteName: 'CL2U',
