...
const _b = '';
export const metadata: Metadata = {
  title: 'Decks – CL2U',
  description: 'Decks section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/decks/' },
  openGraph: {
    title: 'Decks',
    description: 'Decks section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/decks/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Decks">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Decks</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Decks</h1>
