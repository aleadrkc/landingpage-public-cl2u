...
const _b = '';
export const metadata: Metadata = {
  title: 'View All Cards in All Deck Lists – CL2U',
  description: 'View All Cards in All Deck Lists — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/decks/view-all-cards-in-all-deck-lists/' },
  openGraph: {
    title: 'View All Cards in All Deck Lists',
    description: 'View All Cards in All Deck Lists — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/decks/view-all-cards-in-all-deck-lists/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View All Cards in All Deck Lists">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View All Cards in All Deck Lists</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View All Cards in All Deck Lists</h1>
