...
const _b = '';
export const metadata: Metadata = {
  title: 'View Cards in Decklog – CL2U',
  description: 'View Cards in Decklog — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/decks/view-cards-in-decklog/' },
  openGraph: {
    title: 'View Cards in Decklog',
    description: 'View Cards in Decklog — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/decks/view-cards-in-decklog/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Cards in Decklog">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Cards in Decklog</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Cards in Decklog</h1>
