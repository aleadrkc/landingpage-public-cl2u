...
const _b = '';
export const metadata: Metadata = {
  title: 'Delete Deck List – CL2U',
  description: 'Delete Deck List — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/decks/delete-deck-list/' },
  openGraph: {
    title: 'Delete Deck List',
    description: 'Delete Deck List — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/decks/delete-deck-list/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Delete Deck List">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Delete Deck List</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Delete Deck List</h1>
