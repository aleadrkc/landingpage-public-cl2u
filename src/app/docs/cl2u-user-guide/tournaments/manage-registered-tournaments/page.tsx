...
const _b = '';
export const metadata: Metadata = {
  title: 'Manage Registered Tournaments – CL2U',
  description: 'Manage Registered Tournaments — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/manage-registered-tournaments/' },
  openGraph: {
    title: 'Manage Registered Tournaments',
    description: 'Manage Registered Tournaments — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/manage-registered-tournaments/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Registered Tournaments">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Manage Registered Tournaments</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Registered Tournaments</h1>
