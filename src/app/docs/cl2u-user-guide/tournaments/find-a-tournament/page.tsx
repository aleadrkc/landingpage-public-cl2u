...
const _b = '';
export const metadata: Metadata = {
  title: 'Find a Tournament – CL2U',
  description: 'Find a Tournament — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/find-a-tournament/' },
  openGraph: {
    title: 'Find a Tournament',
    description: 'Find a Tournament — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/find-a-tournament/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Find a Tournament">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Find a Tournament</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Find a Tournament</h1>
