...
const _b = '';
export const metadata: Metadata = {
  title: 'View Tournaments History – CL2U',
  description: 'View Tournaments History — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/view-tournaments-history/' },
  openGraph: {
    title: 'View Tournaments History',
    description: 'View Tournaments History — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/view-tournaments-history/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Tournaments History">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Tournaments History</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Tournaments History</h1>
