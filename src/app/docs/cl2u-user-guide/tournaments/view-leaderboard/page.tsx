...
const _b = '';
export const metadata: Metadata = {
  title: 'View Leaderboard – CL2U',
  description: 'View Leaderboard — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/view-leaderboard/' },
  openGraph: {
    title: 'View Leaderboard',
    description: 'View Leaderboard — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/view-leaderboard/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="View Leaderboard">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>View Leaderboard</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">View Leaderboard</h1>
