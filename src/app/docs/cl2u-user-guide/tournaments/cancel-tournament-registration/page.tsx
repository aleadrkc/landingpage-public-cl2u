...
const _b = '';
export const metadata: Metadata = {
  title: 'Cancel Tournament Registration – CL2U',
  description: 'Cancel Tournament Registration — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/cancel-tournament-registration/' },
  openGraph: {
    title: 'Cancel Tournament Registration',
    description: 'Cancel Tournament Registration — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/cancel-tournament-registration/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Cancel Tournament Registration">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Cancel Tournament Registration</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Cancel Tournament Registration</h1>
