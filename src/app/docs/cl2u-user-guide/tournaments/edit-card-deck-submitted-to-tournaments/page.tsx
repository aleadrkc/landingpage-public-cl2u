...
const _b = '';
export const metadata: Metadata = {
  title: 'Edit Card Deck (Submitted to Tournaments) – CL2U',
  description: 'Edit Card Deck (Submitted to Tournaments) — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/tournaments/edit-card-deck-submitted-to-tournaments/' },
  openGraph: {
    title: 'Edit Card Deck (Submitted to Tournaments)',
    description: 'Edit Card Deck (Submitted to Tournaments) — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/tournaments/edit-card-deck-submitted-to-tournaments/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Edit Card Deck (Submitted to Tournaments)">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              <ol className="wedocs-breadcrumb-clone">
                ...
                <li aria-hidden="true">›</li>
                <li><span>Edit Card Deck (Submitted to Tournaments)</span></li>
              </ol>
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Edit Card Deck (Submitted to Tournaments)</h1>
