...
const _b = '';
export const metadata: Metadata = {
  title: 'Manage Dashboard – CL2U',
  description: 'Manage Dashboard — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/accounts/manage-dashboard/' },
  openGraph: {
    title: 'Manage Dashboard',
    description: 'Manage Dashboard — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/accounts/manage-dashboard/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Manage Dashboard">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              ...
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Manage Dashboard</h1>
