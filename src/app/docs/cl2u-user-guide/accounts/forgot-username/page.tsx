...
const _b = '';
export const metadata: Metadata = {
  title: 'Forgot Username – CL2U',
  description: 'Forgot Username — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/accounts/forgot-username/' },
  openGraph: {
    title: 'Forgot Username',
    description: 'Forgot Username — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/accounts/forgot-username/',
    siteName: 'CL2U',
