...
const _b = '';
export const metadata: Metadata = {
  title: 'Accounts – CL2U',
  description: 'Accounts section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/accounts/' },
  openGraph: {
    title: 'Accounts',
    description: 'Accounts section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/accounts/',
    siteName: 'CL2U',
