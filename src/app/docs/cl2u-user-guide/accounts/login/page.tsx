...
const _b = '';
export const metadata: Metadata = {
  title: 'Login – CL2U',
  description: 'Login — documentation section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/accounts/login/' },
  openGraph: {
    title: 'Login',
    description: 'Login — documentation section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/accounts/login/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Login">
