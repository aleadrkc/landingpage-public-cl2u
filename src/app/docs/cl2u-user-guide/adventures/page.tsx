...
const _b = 'PGgzPkFydGljbGVzPC9oMz48dWw+PGxpID48YSBocmVmPSIvZG9jcy9jbDJ1LXVzZXItZ3VpZGUvYWR2ZW50dXJlcy9ob3ctdG8tcmVkZWVtLXRoZS12YW5ndWFyZC1hZHZlbnR1cmVzLyI+SG93IHRvIFJlZGVlbSB0aGUgVmFuZ3VhcmQgQWR2ZW50dXJlczwvYT48L2xpPgo8L3VsPg==';
export const metadata: Metadata = {
  title: 'Adventures – CL2U',
  description: 'Adventures section in the CL2U User Guide for Players.',
  alternates: { canonical: '/docs/cl2u-user-guide/adventures/' },
  openGraph: {
    title: 'Adventures',
    description: 'Adventures section in the CL2U User Guide for Players.',
    url: '/docs/cl2u-user-guide/adventures/',
    siteName: 'CL2U',
  ...
  return (
    <>
      ...
      <main className="doc-category-page">
        <section className="doc-category-content" aria-label="Adventures">
          ...
          <div className="wedocs-single-wrap-clone">
            ...
            <article className="wedocs-single-content-clone" itemScope itemType="https://schema.org/Article">
              ...
              <header className="doc-entry-header-clone">
                <h1 itemProp="headline">Adventures</h1>
